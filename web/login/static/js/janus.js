	...
	function createSession(callbacks) {
		...
		$.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown) {
				...
				if(errorThrown === "")
					{//callbacks.error("Hubo un error con el audio. Luego de reinciar el serivcio, presione llamar nuevamente");
						window.alert("Hubo un error con el audio. Luego de reinciar el serivcio, presione llamar nuevamente");
						window.location = "/upService";
					}
					//callbacks.error(textStatus + ": Se cayo el servicio?");
				else
